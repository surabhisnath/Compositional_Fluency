...
def add_num_features_same_columns(df, featurecols, nbacks=(2, 3, 4, 5)):
    df = get_num_features_same(df, featurecols, column_name="num_features_same", nback=1)
    for n in nbacks:
        df = get_num_features_same(df, featurecols, column_name=f"num_features_same_{n}back", nback=n)
    return df
...
try:
    ...
    for _ in tqdm(range(100)):
        ...
        shuffled_data2 = get_num_features_same(shuffled_data2, vf_featurecols, column_name="num_features_same")
